...
describe("removeFromString", function () {
  it("returns_a_new_string_with_characters_removed", function () {
    ...
    expect(removeFromString('Coding School', 0, 7)).toBe('School') // 'School'
    expect(removeFromString('Coding School', 2, 5)).toBe('CoSchool') // 'CoSchool'
    expect(removeFromString('Coding School', 7, 400)).toBe('Coding ') // 'Coding '
  });
